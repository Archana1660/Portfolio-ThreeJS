  ...
  return <motion.div variants={fadeIn("up","spring",index*0.5,0.75)}>
    <Tilt options={{ max: 45, scale: 1, speed: 300 }} className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full">
      <div className="realtive w-full h-[230px]">
        ...
        <div className="absolute inset-0 justify-end card-img_hover">
          <div onClick={() => window.open(source_code_link, "_blank")} className='balck-gradient w-10 h-10 rounder-full flex justify-center items-center cursor-pointer'>
